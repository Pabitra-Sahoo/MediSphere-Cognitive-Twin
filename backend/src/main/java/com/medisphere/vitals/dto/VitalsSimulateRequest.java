...
/**
 * Request payload for manual or simulator vitals ingestion trigger (POST /api/vitals/simulate).
 */
public class VitalsSimulateRequest {
    ...
    private VitalsSource source = VitalsSource.SIMULATED;
    private Instant recordedAt;

    public VitalsSimulateRequest() {
    }
